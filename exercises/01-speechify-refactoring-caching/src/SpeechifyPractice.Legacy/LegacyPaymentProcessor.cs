...
/// <summary>
/// The shipped implementation. Treat it as the definition of correct behaviour:
/// the equivalence tests compare your refactored service against it.
/// </summary>
public sealed class LegacyPaymentProcessor
{
    /// <summary>
    /// Counts trips to the rate table. Every charge costs one, with no caching.
    /// </summary>
